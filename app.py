...
import pandas as pd
import joblib # to read the parameters files
...
st.title("SBI-Insurance Expense Prediction App")
...
if st.button("Predict Insurance Cost"):
    ...
    # Create dataframe from inputs in order wise
    ...
    # Scale data to transform the data
